...
📍 Palma del Río (Córdoba) | Conéctate conmigo en [LinkedIn](https://www.linkedin.com/in/jos%C3%A9-manuel-s%C3%A1nchez-rosal-863803114/)
...
![JavaFX / Scene Builder](https://img.shields.io/badge/JavaFX-000000?style=for-the-badge&logo=java&logoColor=white)
...
### Control de Versiones, APIs y Testing
...
- **Operador de Campo y Sala de Control — Central Termosolar Cilindro-Parabólica** (Acciona Energía / ContourGlobal S.L.)  
  *2011 – 2024* Control, supervisión y análisis de procesos industriales. Manejo de sistemas DCS (Control Distribuido) y FCS (Campo Solar). Análisis de parámetros en ciclo agua/vapor y operación bajo estrictos procedimientos de seguridad.

- **Técnico Electricista Industrial y Automatización** (Varias empresas)  
  *2005 – 2010* Instalaciones eléctricas industriales, mantenimiento, automatización y puesta en marcha de maquinaria en líneas de envasado. Programación de autómatas y sistemas neumáticos.

---

## 🎓 Formación Académica

- **CFGS Desarrollo de Aplicaciones Multiplataforma (DAM)** — *Actualidad (Finalización prevista 2026)* - **CFGS Sistemas de Regulación y Control Automáticos** — *2007* - **CFGM Técnico en Equipos e Instalaciones Electrotécnicas** — *2005*
